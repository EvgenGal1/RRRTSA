...
* Reducer - fn принимает текущий состояние и экшен (state и action), может обновл. state, возвращает новый state (раб как прослуш.событ. - обраб.событ. на основ.получ.действ.).
  - Правила:
    - только вычисляет новое сост. на основе арг. state и action
    - не измен существ.state. копир существ. внося измен. в копию
    - чистая fn. не выполн. асинхр., др. внешн. вычисления
  - Логика:
    - проверка Reducerа на Actions
    - при Actions, + копия, обновление, возврат
    - если нет Actions, возврат сущест.state
...
<h4>Визуализация/Настройки ввода поиска</h4>
<p>0.9. - 0.19. - 26:22 - 43:43</p>
<p>Описание в файлах. Сюда, возможно, залью позже</p>

<h4>Доп запрос на сервер</h4>
<p>0.20. - 0.28. - 52:32</p>
<p>Описание в файлах. Сюда, возможно, залью позже</p>

<h4>Вывод repo в карточку ++</h4>
<p>0.29. - 0.35 - 01:03:20</p>
<p>Описание в файлах. Сюда, возможно, залью позже</p>

<h4>Добав./удал. в/из избранного</h4>
<p>0.34. - 0.53 - 01:17:15</p>
<p>Описание в файлах. Сюда, возможно, залью позже</p>

<h4>ВСЁ</h4>
<p>Написано мини приложение по поиску репозиториев на GitHub по имени usera, вывод его репозиториев (RTKQuery), и возможность добавить/удалить repo в/из избранного на отдельную страницу/localStorage/State (Redux в оболочке Toolkit)</p>
<p>Разобраны 2 подхода: RTKQuery (Redux Toolkit Query) и Redux в оболочке Toolkit</p>
