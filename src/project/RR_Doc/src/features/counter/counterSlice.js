...
// функция ниже называется селектором и позволяет нам выбрать значение из state .Селекторы также могут быть определены в линии там, где они используются вместо
